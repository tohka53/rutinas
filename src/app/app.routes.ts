...
export const routes: Routes = [
  ...
  { path: 'proxima', loadComponent: () => import('./pages/proxima').then(m => m.ProximaPage), title: 'Próxima semana · Rutina 70.3' },
  { path: 'cumplimiento', loadComponent: () => import('./pages/cumplimiento').then(m => m.CumplimientoPage), title: 'Cumplimiento · Rutina 70.3' },
  { path: 'rendimiento', loadComponent: () => import('./pages/rendimiento').then(m => m.RendimientoPage), title: 'Rendimiento · Rutina 70.3' },
